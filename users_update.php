  ...
  if(!($_SESSION['cred']=='ADMIN')){
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE users  set name = ?, email = ?, mobile =?, username = ? WHERE id = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array($name,$email,$mobile,$username,$id));
            Database::disconnect();
            header("Location: users.php");
        }
    } else {
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="users_update.php?id=<?php echo $id?>" method="post">
